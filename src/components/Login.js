        ...
        <div className="w-4/5 mx-auto hero h-auto my-16">
            <div className="hero-content flex-col lg:flex-row-reverse gap-20">
                <div className="text-center lg:text-left">
                    ...
                    <p className="py-6">You can log in with your signNow, airSlate, or pdfFiller accounts. Facebook. Google. Microsoft. OR. Email is required. Password is required..</p>
                </div>
